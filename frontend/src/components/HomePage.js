                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            ...
                            <p className="mb-4">
                                Administrators can manage all choir activities, members, events, and generate reports.
                            </p>
                            <div className="card bg-primary text-white">
                                <div className="card-body">
                                    {/* <h5>Admin Credentials:</h5>
                                    <p className="mb-1"><strong>Username:</strong> Admin</p>
                                    <p className="mb-0"><strong>Password:</strong> Admin@Nahilot</p> */}
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
